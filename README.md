...
从你选定的历史对话中，找出那些模型容易忽略、你却有来由地想到的判断，再沿着经历、跨领域参与和反复反馈，串成几条有原文证据的故事。
...
这是探索性玩具，不是人格测评或经过验证的因果归因工具。模型一次没想到，并不证明其他模型也想不到；记录里看到某种判断，也不意味着已找到它的起源。
